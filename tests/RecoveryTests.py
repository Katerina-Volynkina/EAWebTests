...
from pages.RecoveryPage import RecoveryPageLocators, RecoveryPageHelperHelper
...
@allure.title('Проверка перехода к восстановлению после нескольких неудачных попытое авторизации')
